...
class RandomHabitAdapter(
    ...
    inner class PagerViewHolder internal constructor(itemView: View) :
        ...
        fun bind(pageType: PageType, pageData: Habit) {
            ...
            val tvtStartTime = itemView.findViewById<TextView>(R.id.pager_tv_start_time)
            val imgPriority = itemView.findViewById<ImageView>(R.id.pager_img_priority)
            ...
            tvtStartTime.text = pageData.startTime
            tvCountTime.text = pageData.title
            tvCountTime.text = pageData.minutesFocus.toString()
            imgPriority.setImageResource(when(pageType) {
